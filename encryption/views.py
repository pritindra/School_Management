        ...
        if form.is_valid():
            try:
                ...
                try:
                    ...
                    return render(request, 'encryption/encrypted.html', {'result': y})
                except:
                ...
                return redirect('encrypt')
    return render(request, 'encryption/encrypt.html', {'form': form})
...
def decrypt(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect('/decrypt')
    return render(request, 'encryption/decrypt.html', {'form': form})
...
def decrypted(request):
    return render(request, 'encryption/decrypted.html')